...
class _PatentDetectiveGameState extends State<PatentDetectiveGame>
  ...
  void _calculateScore() {
    ...
    final correctVerdict = verdictOptions.firstWhere(
      (v) => v['isCorrect'] == true,
    );
            ...
            children: [
              Column(
                children: [
                  ...
                  Text(
                    'Solve IP crime cases like a real detective!',
              ...
              Row(
                ...
                children: [
                  _buildStatChip(
                    Icons.timer,
                    timeString,
                    _timeLeft < 30 ? Colors.red : const Color(0xFF4CAF50),
                  ),
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              'Read each suspect\'s statement carefully',
              style: AppTextStyles.bodyMedium.copyWith(
                color: AppDesignSystem.textSecondary,
              ),
            ),
            ...
            ...suspects.asMap().entries.map((entry) {
              ...
              return AnimatedBuilder(
                ...
                builder: (context, child) {
                  ...
                  final animValue = (_caseOpenController.value - delay).clamp(
                    0.0,
                    1.0,
                  );
  ...
  Widget _buildSuspectCard(Map<String, dynamic> suspect) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
          color: isRead ? const Color(0xFF8B5CF6) : Colors.grey.shade300,
          width: 2,
        ),
        boxShadow: [
          BoxShadow(
            ...
            ...evidence.asMap().entries.map((entry) {
              ...
              return AnimatedBuilder(
                ...
                builder: (context, child) {
                  ...
                  final animValue = (_evidenceRevealController.value - delay)
                      .clamp(0.0, 1.0);
  ...
  Widget _buildEvidenceCard(Map<String, dynamic> item) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
          color: isExamined ? const Color(0xFF8B5CF6) : Colors.grey.shade300,
          width: 2,
        ),
        boxShadow: [
          BoxShadow(
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            '${importance.toUpperCase()} IMPORTANCE',
                            style: TextStyle(
                              fontSize: 11,
                              fontWeight: FontWeight.bold,
                              color: importanceColor,
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              'Answer each question using the evidence',
              style: AppTextStyles.bodyMedium.copyWith(
                color: AppDesignSystem.textSecondary,
              ),
            ),
            ...
            ...deductions.asMap().entries.map((entry) {
              ...
              final isAnswered = deductionAnswers.containsKey(
                deduction['question'],
              );
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ...evidence.map((item) {
                      ...
                      final isLocked = deductionAnswers.containsKey(
                        deduction['question'],
                      );
                      final isCorrect =
                          isLocked &&
                          item['id'] == deduction['correctEvidenceId'];
                      final isWrong =
                          isLocked &&
                          isSelected &&
                          item['id'] != deduction['correctEvidenceId'];
                      ...
                      return GestureDetector(
                        onTap: isLocked
                            ...
                            : () {
                                setState(() {
                                  deductionAnswers[deduction['question']] =
                                      item['id'];
                                  // Update score instantly
                                  if (item['id'] ==
                                      deduction['correctEvidenceId']) {
                                    score += 25;
                                  }
                                });
                              },
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              'Choose the correct verdict based on your investigation',
              style: AppTextStyles.bodyMedium.copyWith(
                color: AppDesignSystem.textSecondary,
              ),
            ),
