...
class _IPDefenderGameState extends State<IPDefenderGame>
  ...
  void _spawnEnemy(List enemies) {
    ...
    final enemyConfig = (_gameData!['enemies'] as List).firstWhere(
      (e) => e['id'] == enemyType,
    );
    ...
    final enemy = Enemy(
      ...
      color: Color(
        int.parse(enemyConfig['color'].toString().replaceFirst('0x', '0xFF')),
      ),
  ...
  Future<void> _saveScore(bool victory) async {
    ...
    if (user != null) {
      try {
        ...
        final maxHealth =
            _gameData!['levels'][_currentLevelIndex]['ipAssetHealth'];
            ...
            Expanded(
              child: LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  final level = _gameData!['levels'][_currentLevelIndex];
                  final refWidth =
                      (level['referenceMapWidth'] as num?)?.toDouble() ?? 830.0;
                  final refHeight =
                      (level['referenceMapHeight'] as num?)?.toDouble() ??
                      1248.0;
                  ...
                  return Stack(
                    ...
                    children: [
                      ...
                      // Enemies
                      ..._activeEnemies.map(
                        (enemy) => _buildEnemyWidget(enemy),
                      ),

                      // Projectiles
                      ..._activeProjectiles.map(
                        (projectile) => _buildProjectileWidget(projectile),
                      ),

                      // Floating Wave Button
                      if (!_waveInProgress &&
                          _currentWaveIndex < waves.length &&
                          !_isPaused)
                        Positioned(
                          bottom: 20,
                          right: 20,
            ...
            children: [
              ...
              Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: _isPaused
                        ? [
                            ...
                            AppDesignSystem.success.withValues(alpha: 0.8),
                          ]
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: (_isPaused ? AppDesignSystem.success : Colors.grey)
                  ...
                  setState(() {
                    _selectedTowerType = isSelected
                        ...
                        : Tower(
                            ...
                            attackSpeed: (towerData['attackSpeed'] as num)
                                .toDouble(),
                            ...
                            color: Color(
                              int.parse(
                                towerData['color'].toString().replaceFirst(
                                  '0x',
                                  '0xFF',
                                ),
                              ),
                            ...
                            slowAmount:
                                (towerData['slowAmount'] as num?)?.toDouble() ??
                                0.0,
                ...
                child: Column(
                  ...
                  children: [
                    Image.asset(
                      ...
                      colorBlendMode: isSelected || !canAfford
                          ? BlendMode.srcIn
                          : null,
                    ),
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: _selectedPlacedTower == tower
              ...
              : null,
          child: Image.asset('assets/${tower.spriteUrl}', fit: BoxFit.contain),
        ),
      ),
    );
  }
                          ...
                          child: Container(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                boxShadow: [
                                  BoxShadow(
                                    color: AppDesignSystem.error.withOpacity(
                                      0.1,
                                    ),
                                    blurRadius: 20,
                                    offset: const Offset(0, 10),
...
class GamePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (dragPosition != null && selectedTowerType != null) {
      ...
      canvas.drawCircle(dragPosition!, selectedTowerType!.range * 40, paint);
