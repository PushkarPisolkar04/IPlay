...
class RealmDetailScreen extends StatefulWidget {
  ...
  const RealmDetailScreen({super.key, required this.realm});
...
class _RealmDetailScreenState extends State<RealmDetailScreen> {
  ...
  Future<void> _loadData() async {
    try {
      ...
      if (user != null) {
        final progress = await _progressService.getRealmProgress(
          user.uid,
          realmId,
        );
        if (progress != null) {
                      ...
                      child: Row(
                        children: [
                          ...
                          Container(
                            ...
                            child: Image.asset(
                              widget.realm['iconPath'] as String? ??
                                  'assets/icons/realm_default.png',
                              width: 50,
                              height: 50,
                    ...
                    ...(_levels.map((level) {
                      ...
                      return Padding(
                        ...
                        child: _LevelItem(
                          ...
                          xp: level.xpReward,
                          stars:
                              _levelStars[level.levelNumber] ??
                              0, // Use actual star rating
                          status: status,
                          color: color,
                                  ...
                                  final result = await Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) => LevelPreviewScreen(
                                        levelId: level.id,
                                        realmId:
                                            widget.realm['realmId'] as String,
                                      ),
                                    ),
                                  );
                            ...
                            Row(
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: isCompleted
                                        ? AppDesignSystem.success.withOpacity(
                                            0.15,
                                          )
                                        : isCurrent
                                        ? color.withOpacity(0.15)
